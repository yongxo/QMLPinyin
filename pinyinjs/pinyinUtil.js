 ...
 * @last 2016-09-29
 */
Qt.include("./dict/pinyin_dict_withtone.js")
Qt.include("./dict/pinyin_dict_notone.js")
Qt.include("./dict/pinyin_dict_polyphone.js")
Qt.include("./dict/pinyin_dict_firstletter.js")


//;(function(global, factory) {
//    //console.log("------global-------", global.objectName(), factory)
...
//   , function(window) {
//    var pinyin_dict_firstletter = true
//    console.log("------global--111-----", window.pinyin_dict_firstletter)
//window.pinyin_dict_firstletter = ture
var toneMap =
        {
    "ā": "a1",
    "á": "a2",
...
var pinyinUtil =
    ...
    parseDict: function()
    {
        ...
        console.log("---------pinyin_dict_notone--------")
        ...
        {
            console.log("---------pinyin_dict_withtone--------")
